...
func (g *Game) Draw(screen *ebiten.Image) {
	...
	txt := fmt.Sprintf("μ: %.3f  σ: %.3f  Δt: %.3f  FPS: %d", g.mu, g.sigma, g.dt, g.lastFPS)
	text.Draw(screen, txt, basicfont.Face7x13, 6, 18, color.White)
	help := "Dynamic evolution: parameters change over time"
...
func main() {
	...
	ebiten.SetWindowTitle("Dynamic Lenia-like Artificial Life (Ebiten)")
